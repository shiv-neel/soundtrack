...
public class FriendsNotificationsRecylerViewAdapter extends RecyclerView.Adapter<FriendsNotificationsRecylerViewAdapter.NotificationsViewHolder> {
    private ArrayList<UserLists> values;
    private Context context;

    public FriendsNotificationsRecylerViewAdapter(ArrayList<UserLists> values, Context context) {
        this.values = values;
...
//            itemView.setOnClickListener();
            ...
            buttonAccept.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String acceptFriendRequestUrl = "https://coms-309-026.class.las.iastate.edu/api/userRelationships/acceptFriendRequest/" + friendRequestAccount.getText().toString();
                    ...
                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, acceptFriendRequestUrl, temp,
                            response -> {
                                Log.d(NotificationsViewHolder.class.getSimpleName(), response.toString());
                            }, error -> {
            ...
            buttonDecline.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    RequestQueue queue = AppController.getInstance().getRequestQueue();
                    String declineFriendRequestUrl = "https://coms-309-026.class.las.iastate.edu/api/userRelationships/declineFriendRequest/" + friendRequestAccount.getText().toString();
                    JSONObject temp = new JSONObject();
                    try {
                        temp.put("username", friendRequestAccount.getText().toString());
                    } catch (JSONException e) {
